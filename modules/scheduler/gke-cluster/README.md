...
| <a name="output_configure_workload_identity_sa"></a> [configure\_workload\_identity\_sa](#output\_configure\_workload\_identity\_sa) | Workload identity k8s service account |
